...
if has("gui_running")
    ...
    hi CursorLine     gui=NONE   guifg=NONE      guibg=#32323f
    ...
    "hi lCursor        gui=NONE   guifg=#000000   guibg=#8b8bff
    hi lCursor        gui=NONE   guifg=#000000   guibg=#8b8bff
    ...
    exec "hi Folded         cterm=NONE   ctermfg=" . <SID>X("37") . "   ctermbg=" . <SID>X(80) . ""
