...
if has("gui_running")
    if ! g:inkpot_black_background
        hi Normal         gui=NONE   guifg=#eeeeee   guibg=#0a0630
    else
    ...
    hi Cursor         gui=NONE   guifg=#404040   guibg=#efe34b
    hi lCursor        gui=NONE   guifg=#404040   guibg=#8fff8b
    hi CursorIM       gui=NONE   guifg=#404040   guibg=#8b8bff

    hi Folded         gui=NONE   guifg=#efe34b   guibg=NONE
    "hi FoldColumn     gui=NONE   guifg=#8b8bcd   guibg=#2e2e2e
    hi ColorColumn    gui=NONE   guifg=NONE      guibg=#2e2e37

    hi Directory      gui=NONE   guifg=#00ff8b   guibg=NONE
    hi LineNr         gui=NONE   guifg=#666666   guibg=#2e2e2e
    ...
    hi Constant       gui=NONE   guifg=#efe34b   guibg=NONE
    hi String         gui=NONE   guifg=#aaaaaa   guibg=#202020
    hi Error          gui=NONE   guifg=#ffffff   guibg=#6e2e2e
    hi Identifier     gui=NONE   guifg=#ffffff   guibg=NONE
    hi Ignore         gui=NONE
    hi Number         gui=NONE   guifg=#efe34b   guibg=NONE
    hi PreProc        gui=NONE   guifg=#409090   guibg=NONE
    hi Special        gui=NONE   guifg=#00c23c   guibg=NONE
    hi SpecialChar    gui=NONE   guifg=#efe34b   guibg=#404040
    hi Statement      gui=NONE   guifg=#52d2ec   guibg=NONE
    hi Todo           gui=BOLD   guifg=#ff361b   guibg=NONE
    hi Type           gui=NONE   guifg=#aaaaaa   guibg=NONE
    hi Underlined     gui=BOLD   guifg=#df9f2d   guibg=NONE
    hi TaglistTagName gui=BOLD   guifg=#52d2ec   guibg=NONE
    ...
    if v:version >= 700
        ...
        hi MatchParen   gui=NONE      guifg=#ffffff   guibg=#4e4e8f
    endif
else
    if ! g:inkpot_black_background
